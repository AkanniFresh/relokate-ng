  ...
  return (
    <footer className="bg-gray-900 text-white pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <motion.div variants={itemVariants}>
            ...
            <div className="flex space-x-4">
              ...
              <motion.a 
                href="https://x.com/relokate_ng"  target="_blank"
                className="bg-gray-800 p-2 rounded-full text-gray-400 hover:text-white hover:bg-primary transition duration-300"
                whileHover={{ y: -5, scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
              >
              ...
              <motion.a 
                ...
                whileTap={{ scale: 0.9 }}
              >
                <img src="./logos/whatsapp.png" className="h-5 w-5" alt="whatsapp icon"  />
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-3">
              {["Privacy Policy", "Terms & Conditions", "FAQ", "Trip Guides"].map((link, index) => (
                <motion.li 
                  key={index}
                  whileHover={{ x: 5 }}
                  transition={{ type: "spring", stiffness: 400 }}
        ...
        >
          <p>&copy; {new Date().getFullYear()} Relokate | Powered by Aresa Travels & Tours.</p>
        </motion.div>
      </div>
    </footer>
  );
