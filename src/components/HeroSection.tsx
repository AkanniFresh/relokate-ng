  ...
  return (
    <section className="relative bg-gray-100 overflow-hidden h-[75vh]">
      ...
      <div className="container mx-auto px-4 py-16 md:py-32 relative z-10 flex flex-col justify-center items-center h-[75vh]">
        ...
        >
          <motion.h1 
            className="text-4xl italic md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4 text-center"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.5 }}
          >
            From Here to Anywhere
            {/* Explore the World, <br />One Trip at a Time Your Global Future Starts Here*/}
          </motion.h1>
          <motion.p 
